package com.lqb.ss.MyShardingSphere.mybatisPlusGenerator;
...
public class MyBatisPlusCustomGenerator {
    ...
    private static String jdbcUrl = "jdbc:mysql://localhost:3306/shool_sys?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&zeroDateTimeBehavior=round&useSSL=false";
    private static String username = "root";
    private static String password = "123456";

    private static String parent = "com.mykj.shool.sys";

    private static String[] include = new String[]{"sys_cap"};
